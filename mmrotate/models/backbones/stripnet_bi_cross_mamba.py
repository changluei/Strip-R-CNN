...
class BiMambaWrapper(nn.Module):
    ...
    def __init__(self, dim, d_state=16, d_conv=4, expand=2):
        ...
        self.reverse_mamba = Mamba(d_model=dim, d_state=d_state, d_conv=d_conv, expand=expand)
...
class AxialCrossMambaBi(nn.Module):
    def __init__(self, dim, d_state=16, d_conv=4, expand=2):
        ...
        self.anti_diag_bimamba = BiMambaWrapper(dim, d_state, d_conv, expand)
...
class StripDMambaNet(BaseModule):
    def __init__(
        self,
        img_size=224,
        in_chans=3,
