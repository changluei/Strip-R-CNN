...
custom_imports = dict(
    imports=[
        ...
        'mmrotate.models.roi_heads.task_aligned_oriented_standard_roi_head',
        'mmrotate.models.roi_heads.bbox_heads.strip_head_tal',
    ],
    allow_failed_imports=False)

model = dict(
    roi_head=dict(
        type='TaskAlignedOrientedStandardRoIHead',
        append_gt_as_proposals=True,
        bbox_head=dict(type='StripHeadTAL')),
    train_cfg=dict(
        rcnn=dict(
            assigner=dict(
                _delete_=True,
